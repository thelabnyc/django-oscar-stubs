...
class AbstractConditionalOffer(models.Model):
    ...
    # Reverse relation from AbstractVoucher.offers (related_name="vouchers")
    vouchers: models.Manager[AbstractVoucher]
    ...
    def is_available(
        self, user: User | None = ..., test_date: datetime.date | datetime.datetime | None = ...
    ) -> bool: ...
    ...
    def record_usage(self, discount: OfferApplication | dict[str, Any]) -> None: ...
    def availability_description(self) -> str: ...
    def availability_restrictions(self) -> list[Any]: ...
    @property
...
class AbstractBenefit(BaseOfferMixin, models.Model):
    ...
    # Reverse relation from AbstractConditionalOffer.benefit (related_name="offers")
    ...
    def get_applicable_lines(
        self, offer: AbstractConditionalOffer, basket: Any, range: AbstractRange | None = ...
...
class AbstractCondition(BaseOfferMixin, models.Model):
    ...
    # Reverse relation from AbstractConditionalOffer.condition (related_name="offers")
    offers: models.Manager[AbstractConditionalOffer]
    ...
    def consume_items(
        ...
        affected_lines: Any,
    ) -> list[tuple[Any, Decimal, int]] | None: ...
    ...
    def get_applicable_lines(
        self, offer: AbstractConditionalOffer, basket: Any, most_expensive_first: bool = ...
    ) -> list[tuple[Decimal, Any]]: ...
    def get_type_display(self) -> str: ...
...
class AbstractRangeProductFileUpload(models.Model):
    ...
    def extract_ids(self, file_obj: IOBase) -> Iterator[str]: ...
